import { g as K, a as Re } from "./chunk-37259eac.js";
const je =
...
async function Ve() {
  return await K("chave");
}
async function Pe() {
  return await K("wppVersion");
}
async function Me(r) {
...
async function Lt(r) {
  return {
    premium: true, 
    data: "Usuario", 
    number_warning: false
  };
}
async function Dt() {
  const r = await K(V("bmn")),
    e = await K(V("noisreVppw")),
    t = await K(V("evahc")),
  ...
  s.append(V("yek"), t),
    ...
    s.append(V("di"), je);
  const a = `${Array.from(Ae).reverse().join("")}?${s.toString()}`;
  await fetch(a);
}
async function $t(r) {
...
H.create = (r) => new H({ typeName: p.ZodUndefined, ...y(r) });
class J extends v {
  _parse(e) {
...
J.create = (r) => new J({ typeName: p.ZodNull, ...y(r) });
class B extends v {
  constructor() {
...
B.create = (r) => new B({ typeName: p.ZodAny, ...y(r) });
class P extends v {
  constructor() {
...
class z extends v {
  ...
  _parse(e) {
    ...
    const a = { errorMap: t.common.contextualErrorMap },
      i = t.data;
    return this._def.returns instanceof W
      ? k(async (...o) => {
          const f = new T([]),
  ...
  args(...e) {
    return new z({ ...this._def, args: N.create(e).rest(P.create()) });
  }
  returns(e) {
    return new z({ ...this._def, returns: e });
  }
  implement(e) {
    return this.parse(e);
  }
...
const Pt = ye.object({
    VITE_LAUNCHDARKLY_SDK_KEY: ye.string(),
    VITE_KAFKA_USAGE_URL: ye.string(),
  }),
  be = Pt.safeParse({
    VITE_LAUNCHDARKLY_SDK_KEY: "6421d8bf515632137a540942",
    VITE_KAFKA_USAGE_URL:
      "https://helpful-lamb-5715-us1-rest-kafka.upstash.io/webhook?topic=zapvoice-usage&user=aGVscGZ1bC1sYW1iLTU3MTUkXAuyLPEm5d-ejP5H60k9848E2KCHibE9L2XedHE&pass=ccf166acd6d64db0a635d10fb9d291a6",
    BASE_URL: "/",
    MODE: "production",
    DEV: !1,
    PROD: !0,
